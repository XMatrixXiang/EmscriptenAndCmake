...
set(BS_BINARY_DEP_WEBSITE "http://dbj-test.oss-cn-beijing.aliyuncs.com/updatePackages/SCT_Dependencies/SCTRpcWithoutEngine" CACHE STRING "The location that binary dependencies will be pulled from")
...
function(update_binary_deps DEP_PREFIX DEP_NAME DEP_FOLDER DEP_VERSION)
	...
	if(EXISTS ${PROJECT_SOURCE_DIR}/Temp/${DEP_PREFIX}/bin)
		execute_process(COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_SOURCE_DIR}/Temp/${DEP_PREFIX}/bin ${DEP_FOLDER}/../../bin)	
	endif()
