function(PrepareDocTarget)
  ...
  #message(WARNING "doxygen WORKING_DIRECTORY :${CMAKE_CURRENT_BINARY_DIR}")
  set(INSTALL_DOC_DIR ${CMAKE_BINARY_DIR}/doc/${PROJECT_NAME}/html)
  file(MAKE_DIRECTORY ${INSTALL_DOC_DIR}) # needed for install

  install(DIRECTORY ${INSTALL_DOC_DIR} DESTINATION ${PROJECT_NAME}-${VERSION_MAJOR} COMPONENT doc)
